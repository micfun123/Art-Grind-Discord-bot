...
class story(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if (self.message_id == None):
            ...
            elif message.channel.overwrites[role].send_messages == True or message.channel.overwrites[role].send_messages == None:
    ...
    async def on_raw_reaction_add(self, payload):
        ...
        if (message == self.message_id):
            ...
            if (upvotes+downvotes >= 5): #and ((downvotes / upvotes) < 0.4 or (upvotes / downvotes) < 0.4)):
                if (upvotes - downvotes >= 2):
                    ...
                    if role not in content.channel.overwrites:
                        ...
                        overwrites.send_messages = True
                        await content.channel.set_permissions(role, overwrite=overwrites)
